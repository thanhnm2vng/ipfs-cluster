...
export CLUSTER_PEERADDRESSES='ipfs-cluster-0.ipfs-cluster-all.ipfs.svc.cluster.local,ipfs-cluster-1.ipfs-cluster-all.ipfs.svc.cluster.local,ipfs-cluster-2.ipfs-cluster-all.ipfs.svc.cluster.local'
